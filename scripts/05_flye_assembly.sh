...
#SBATCH --output=/data/users/asteiner/assembly_annotation_course/assembly/flye/output_flye_%j.o
#SBATCH --error=/data/users/asteiner/assembly_annotation_course/assembly/flye/error_flye_%j.e
