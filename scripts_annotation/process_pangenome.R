...
# 0) Inputs
# -----------------
wd <- "/data/users/asteiner/assembly_annotation_course/GENESPACE/genespace_WD" # set your working directory where the pangenome_matrix.rds is located
focal_genome <- "Nemrut_1" # Your focal accession name
