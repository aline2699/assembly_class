...
data <- "/data/users/asteiner/assembly_annotation_course/R_visualizations/parseRM_results/ERR11437351.asm.bp.p_ctg.fa.mod.out.landscape.Div.Rname.tab"
...
ggsave(filename = "/data/users/asteiner/assembly_annotation_course/R_visualizations/plots/output.pdf", width = 10, height = 5, useDingbats = F)
