...
#-------------------------------------------------
gff_file <- "/data/users/asteiner/assembly_annotation_course/EDTA/results/EDTA_annotation/ERR11437351.asm.bp.p_ctg.fa.mod.EDTA.raw/ERR11437351.asm.bp.p_ctg.fa.mod.LTR.intact.raw.gff3"
cls_file <- "/data/users/asteiner/assembly_annotation_course/TEsorter/results/ERR11437351.asm.bp.p_ctg.fa.mod.LTR.raw.fa.rexdb-plant.cls.tsv"
...
ggsave("R_visualizations/plots/01_LTR_Copia_Gypsy_cladelevel.png", combined, width = 12, height = 10, dpi = 300)
ggsave("R_visualizations/plots/01_LTR_Copia_Gypsy_cladelevel.pdf", combined, width = 12, height = 10)